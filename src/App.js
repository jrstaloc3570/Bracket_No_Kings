...
const PRINT_BOARD_WIDTH =
  PRINT_LAYOUT.regionWidth * 2 +
  PRINT_LAYOUT.centerWidth +
  PRINT_LAYOUT.boardGap * 2;
const PRINT_BOARD_HEIGHT =
  PRINT_LAYOUT.roundHeight * 2 + PRINT_LAYOUT.regionStackGap + 56;
...
function ThroneOrange() {
  return (
    <svg width="120" height="100" viewBox="0 0 200 180" aria-hidden="true">
      ...
      <path
        d="M70 45 L85 30 L100 45 L115 30 L130 45"
        stroke={BRAND.orange}
        strokeWidth="3"
        fill="none"
      />
    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M26 66 L58 126 L98 40 L138 126 L172 66"
            stroke={BRAND.orange}
            strokeWidth="6"
            fill="none"
          />
...
function GameCard(props) {
  const { gameId, teams, picks, setPick, highlight, align, round, layout } =
    props;
  ...
  return (
    ...
    >
      ...
      <TeamLine
        text={teams[0]}
        active={winner === teams[0]}
        onClick={() => setPick(gameId, teams[0])}
        align={align}
        fontSize={fontSize}
      />
      <TeamLine
        text={teams[1]}
        active={winner === teams[1]}
        onClick={() => setPick(gameId, teams[1])}
        align={align}
        fontSize={fontSize}
      />
    </div>
...
function RegionConnectors({ reverse, xPositions, rounds, layout }) {
  const connector = (fromCenters, toCenters, fromIndex, toIndex) => {
    const x1 = reverse
      ? xPositions[fromIndex]
      : xPositions[fromIndex] + layout.columnWidth;
    const x2 = reverse
      ? xPositions[toIndex] + layout.columnWidth
      : xPositions[toIndex];
    const midX = (x1 + x2) / 2;
...
function Region({ region, reverse, picks, setPick, prefix, layout }) {
  ...
  const xPositions = reverse
    ? [
        layout.columnWidth * 3 + layout.columnGap * 3,
        layout.columnWidth * 2 + layout.columnGap * 2,
        layout.columnWidth + layout.columnGap,
        0,
      ]
    : [
        0,
    ...
    <div style={{ width: layout.regionWidth }}>
      <h3
        style={{
          ...
          textAlign: align,
          marginBottom: 8,
          fontSize: layout === PRINT_LAYOUT ? 12 : 15,
        }}
      >
        {region.name}
      </h3>
  ...
  return (
    ...
    >
      ...
      <svg
        ...
        height={printMode ? 88 : 120}
        viewBox={`0 0 ${layout.centerWidth} ${printMode ? 88 : 120}`}
        style={{
          position: "absolute",
          top: printMode ? 48 : 54,
          pointerEvents: "none",
      ...
      >
        <path
          d={`M ${printMode ? 108 : 135} ${printMode ? 36 : 48} H ${
            printMode ? 150 : 195
          } V ${printMode ? 70 : 92} H ${printMode ? 180 : 225}`}
        ...
        />
        <path
          d={`M ${layout.centerWidth - (printMode ? 108 : 135)} ${
            printMode ? 36 : 48
          } H ${layout.centerWidth - (printMode ? 150 : 195)} V ${
            printMode ? 70 : 92
          } H ${layout.centerWidth - (printMode ? 180 : 225)}`}
          stroke="rgba(15,23,42,0.24)"
          strokeWidth="1.5"
          fill="none"
          strokeLinecap="round"
          ...
          <>
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "radial-gradient(circle, rgba(249,115,22,0.16), transparent 70%)",
                top: 22,
                zIndex: 0,
                pointerEvents: "none",
              }}
...
function BracketBoard({ picks, setPick, layout, printMode }) {
  ...
  const boardWidth =
    layout.regionWidth * 2 + layout.centerWidth + layout.boardGap * 2;
  ...
  return (
    <div style={{ width: boardWidth, margin: "0 auto" }}>
      <div
        style={{
          display: "grid",
          gridTemplateColumns: `${layout.regionWidth}px ${layout.centerWidth}px ${layout.regionWidth}px`,
          gap: layout.boardGap,
          alignItems: "start",
        }}
      >
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ fontSize: 18, fontWeight: 800, color: BRAND.orange }}>
            Share Bracket URL
          </div>
        ...
        <div style={{ color: "rgba(255,255,255,0.7)", marginBottom: 12 }}>
          Copy the URL below to share this exact bracket state.
        </div>
        <textarea
          readOnly
          value={text}
      ...
      >
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(circle at center, rgba(249,115,22,0.02), transparent 55%)",
          }}
        />
        ...
        >
          ...
          >
            ...
            <button onClick={handlePrintPdf} style={btnStyle}>
              Print / Save PDF
            </button>
          </div>
            ...
            {ROUND_BANNER.map((item, i) => (
              <div
                ...
                style={{
                  ...
                  padding: "6px 10px",
                  background:
                    i === 5 ? "rgba(249,115,22,0.12)" : "rgba(15,23,42,0.035)",
                  borderRadius: 8,
                  textAlign: "center",
                }}
              >
        ...
        <div
          className="print-only print-page"
